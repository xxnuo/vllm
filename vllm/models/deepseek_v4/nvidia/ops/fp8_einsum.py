...
"""Triton FP8 einsum fallback for DeepSeek V4 on SM110."""
...
def _deepseek_v4_sm110_fp8_einsum_kernel(
    a_ptr,
    a_scale_ptr,
    b_ptr,
    b_scale_ptr,
...
def deepseek_v4_sm110_fp8_einsum(
    ...
    """Compute ``bhr,hdr->bhd`` with FP32 block scales."""
    ...
    _deepseek_v4_sm110_fp8_einsum_kernel[grid](
        a,
        a_scale,
        b,
        b_scale,
...
def deepseek_v4_fp8_einsum_config(
    ...
    if (capability_major, capability_minor) == (11, 0):
...
def _use_deepseek_v4_sm110_triton_fp8_einsum(
    equation: str,
    recipe: list[int],
    b_scale: torch.Tensor,
) -> bool:
